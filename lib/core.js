...
async function createPatternFiles(options) {
    ...
    writeFile(`../entities/`, `${options.formName}.service.js`, TemplatesService.getDataService(options));
    switch (options.patternName) {
        ...
        case PATTERNS.SIMPLE_LIST_DETAILS:
            ...
            if (options.details) {
                ...
                writeFile(options.formName + '/blocks/details', 'details.form.js', TemplatesService.getSLDContent(options));
            ...
            if (options.navigation) {
                ...
                writeFile(options.formName + '/blocks/navigation', 'navigation.form.js', TemplatesService.getSLDNavigation(options))
            }
            if (options.footer) {
                await createDirectory(options.formName + '/blocks/footer');
                writeFile(options.formName + '/blocks/footer', 'footer.form.js', TemplatesService.getSLDNavigation(options))
            }
            break;
